...
-- CreateIndex
CREATE UNIQUE INDEX "PageBook_bookId_pageNumber_key" ON "PageBook"("bookId", "pageNumber");
...
-- AddForeignKey
ALTER TABLE "PageBook" ADD CONSTRAINT "PageBook_bookId_fkey" FOREIGN KEY ("bookId") REFERENCES "Book"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
